...
import { fromStrapiNote } from '@/utils/strapiMappers';
...
export async function fetchCommunityPinnedNotes(): Promise<NoteType[]> {
...
export async function fetchCommunityPinnedNote(id: string): Promise<NoteType> {
